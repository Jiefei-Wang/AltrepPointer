...
RcppExport SEXP _AltrepPointer_C_get_finalizer(SEXP ExtptrSEXP, SEXP operationSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type Extptr(ExtptrSEXP);
    Rcpp::traits::input_parameter< SEXP >::type operation(operationSEXP);
    rcpp_result_gen = Rcpp::wrap(C_get_finalizer(Extptr, operation));
    return rcpp_result_gen;
END_RCPP
}
// C_attachAttr
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_AltrepPointer_C_get_finalizer", (DL_FUNC) &_AltrepPointer_C_get_finalizer, 2},
