...
#define ALT_COMMOM_REG(ALT_CLASS,ALT_TYPE,target_C_TYPE,source_C_type,R_TYPE)                   \
...
R_set_altvec_Extract_subset_method(ALT_CLASS, altrep_subset<R_TYPE, target_C_TYPE,source_C_type>); \
/* override ALTREAL methods */                                                 \
R_set_##ALT_TYPE##_Elt_method(ALT_CLASS, altrep_Elt<target_C_TYPE>);                 \
R_set_##ALT_TYPE##_Get_region_method(ALT_CLASS, altrep_region<target_C_TYPE,source_C_type>);
...
void init_raw_class(DllInfo* dll)
{
	...
	ALT_COMMOM_REG(altrep_raw_class, altraw, C_TYPE, C_TYPE, R_TYPE)
}
#undef C_TYPE
#undef R_TYPE
...
void init_logical_class(DllInfo* dll) {
	...
	ALT_COMMOM_REG(altrep_logical_class, altlogical, C_TYPE, bool, R_TYPE)
}
#undef C_TYPE
#undef R_TYPE
...
void init_integer_class(DllInfo* dll) {
	...
	ALT_COMMOM_REG(altrep_integer_class, altinteger, C_TYPE, C_TYPE, R_TYPE)
}
#undef C_TYPE
#undef R_TYPE
...
void init_real_class(DllInfo* dll)
{
	...
	ALT_COMMOM_REG(altrep_real_class, altreal, C_TYPE, C_TYPE, R_TYPE)
}
#undef C_TYPE
#undef R_TYPE
